...
\begin{figure}[H]
    \lstinputlisting{cookie_theft.html}
...
Lastly, lines 15--17 is simply a regular message, so as to avoid suspicion of
...
or as in this case, produce an HTML element or similar malicious technique.
